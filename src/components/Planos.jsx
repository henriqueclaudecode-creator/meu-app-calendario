...
const estilos = {
  ...
  trialDestaque: { fontSize: 15.5, fontWeight: 800, letterSpacing: -0.3, color: cores.acento, marginTop: 2 },
  depois: { fontSize: 14, fontWeight: 700, color: cores.texto, marginTop: 3 },
