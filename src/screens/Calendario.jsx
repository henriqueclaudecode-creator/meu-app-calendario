...
// Fundo "vidro fosco" dos chips de evento: um leve brilho no topo e um leve
        ...
        {visiveis.map((e) => {
          ...
          return (
            <span
              ...
              style={{ ...estilos.chip, background: vidroChip(c), color: corTexto(c), cursor: 'pointer' }}
              title={e.titulo}
            >
              {e.titulo}
            </span>
        ...
        {visiveis.map((e) => {
          ...
          return (
            <span
              ...
              style={{ ...estilos.chipSemana, background: vidroChip(c), color: corTexto(c), cursor: 'pointer' }}
              title={e.titulo}
            >
...
const estilos = {
  ...
  favCard: { flex: '0 0 auto', width: 150, boxSizing: 'border-box', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: 5, background: cores.superficie, border: `1px solid ${cores.borda}`, borderRadius: raio, boxShadow: sombraSuave, padding: '8px 12px', cursor: 'pointer' },
